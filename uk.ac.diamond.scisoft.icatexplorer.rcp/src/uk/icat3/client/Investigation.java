...
@XmlType(name = "investigation", propOrder = { "bcatInvStr",
		"datasetCollection", "facility", "facilityCycle", "grantId", "id",
		"instrument", "invAbstract", "invEndDate", "invNumber", "invParamName",
		"invParamValue", "invStartDate", "invType", "investigatorCollection",
		"keywordCollection", "prevInvNumber", "publicationCollection",
		"releaseDate", "sampleCollection", "shiftCollection", "title",
		"visitId" })
public class Investigation extends EntityBaseBean {
	 ...
	 * <CODE>set</CODE> method for the datasetCollection property.
	 * 
	 * <p>
	 ...
	 * 
	 * @return possible object is {@link FacilityCycle }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link FacilityCycle }
	 * 
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the investigatorCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the keywordCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the publicationCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the sampleCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the shiftCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Shift }
	 * 
	 * 
	 */
