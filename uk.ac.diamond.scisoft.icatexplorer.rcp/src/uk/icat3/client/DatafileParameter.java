...
@XmlType(name = "datafileParameter", propOrder = { "datafileParameterPK",
		"description", "error", "numeric", "numericValue", "rangeBottom",
		"rangeTop", "stringValue" })
public class DatafileParameter extends EntityBaseBean {
