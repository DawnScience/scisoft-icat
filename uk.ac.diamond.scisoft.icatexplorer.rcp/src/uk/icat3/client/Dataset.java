...
@XmlType(name = "dataset", propOrder = { "datafileCollection",
		"datasetParameterCollection", "datasetStatus", "datasetType",
		"description", "id", "investigationId", "location", "name", "sampleId" })
public class Dataset extends EntityBaseBean {
	 ...
	 * <CODE>set</CODE> method for the datafileCollection property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the datasetParameterCollection property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
