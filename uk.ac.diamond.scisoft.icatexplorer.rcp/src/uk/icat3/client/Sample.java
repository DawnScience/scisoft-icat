...
@XmlType(name = "sample", propOrder = { "chemicalFormula", "id", "instance",
		"name", "proposalSampleId", "safetyInformation",
...
public class Sample extends EntityBaseBean {
	 ...
	 * <CODE>set</CODE> method for the sampleParameterCollection property.
	 * 
	 * <p>
