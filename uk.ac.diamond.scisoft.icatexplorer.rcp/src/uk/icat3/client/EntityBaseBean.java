...
@XmlType(name = "entityBaseBean", propOrder = { "facilityAcquiredData",
		"icatRole", "selected", "uniqueId" })
@XmlSeeAlso({ FacilityUser.class, Investigator.class, Investigation.class,
		Datafile.class, DatafileParameter.class, Dataset.class,
		RelatedDatafiles.class, IcatAuthorisation.class, Sample.class,
		FacilityCycle.class, DatafileFormat.class, Shift.class,
		DatasetParameter.class, IcatRole.class, SampleParameter.class,
		Parameter.class, Keyword.class, Publication.class })
