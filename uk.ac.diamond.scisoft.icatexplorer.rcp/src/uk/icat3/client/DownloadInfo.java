...
/**
 * <p>
 * Java class for downloadInfo complex type.
 * 
 * <p>
...
@XmlType(name = "downloadInfo", propOrder = { "credential",
		"datafileLocations", "datafileNames", "userId" })
public class DownloadInfo {
	 ...
	 * <CODE>set</CODE> method for the datafileLocations property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the datafileNames property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
