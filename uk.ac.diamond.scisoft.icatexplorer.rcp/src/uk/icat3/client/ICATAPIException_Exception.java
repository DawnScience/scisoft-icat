...
public class ICATAPIException_Exception extends Exception {
	 ...
	 * @param cause
	 */
	public ICATAPIException_Exception(String message,
			ICATAPIException faultInfo, Throwable cause) {
		super(message, cause);
		this.faultInfo = faultInfo;
	}
	...
	/**
	 * 
	 * @return returns fault bean: uk.icat3.client.ICATAPIException
	 */
