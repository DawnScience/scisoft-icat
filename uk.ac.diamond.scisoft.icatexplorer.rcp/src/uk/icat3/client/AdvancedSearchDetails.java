...
@XmlType(name = "advancedSearchDetails", propOrder = {
		"backCatalogueInvestigatorString", "caseSensitive", "datafileName",
		"dateRangeEnd", "dateRangeStart", "experimentNumber", "grantId",
		"instruments", "investigationAbstract", "investigationInclude",
		"investigationName", "investigationType", "investigators", "keywords",
		"runEnd", "runStart", "sampleName", "visitId" })
public class AdvancedSearchDetails {
	 ...
	 * <CODE>set</CODE> method for the instruments property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the investigators property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
