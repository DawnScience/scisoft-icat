...
/**
 * <p>
 * Java class for icatRole complex type.
 * 
 * <p>
...
@XmlType(name = "icatRole", propOrder = { "actionDelete", "actionDownload",
		"actionFacilityAcquired", "actionInsert", "actionManageUsers",
		"actionRemove", "actionRootInsert", "actionRootRemove", "actionSelect",
		"actionUpdate", "role" })
public class IcatRole extends EntityBaseBean {
