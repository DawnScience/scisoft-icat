...
package uk.ac.diamond.scisoft.icatexplorer.v42.rcp.preferences;
...
import uk.ac.diamond.scisoft.icatexplorer.v42.rcp.utils.NetworkUtils;
...
public class ICATPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		logger.debug("init ICAT v4.2 preferences");
	...
	protected Control createContents(Composite parent) {
		...
		btnSftpTest.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(NetworkUtils.isReachable(textICATsftpServer.getText())){
					Image okImage = (ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v42.rcp", "icons/ok.png"));;
					btnSftpTest.setImage(okImage);
				}else{
					Image noImage = (ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v42.rcp", "icons/no.png"));;
		...
		btnTestWS.setImage(ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v42.rcp", "icons/database.png"));
