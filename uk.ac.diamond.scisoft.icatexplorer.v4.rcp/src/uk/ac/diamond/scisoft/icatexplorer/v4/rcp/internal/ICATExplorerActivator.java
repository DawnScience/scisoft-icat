...
package uk.ac.diamond.scisoft.icatexplorer.v4.rcp.internal;
 ...
 */
public class ICATExplorerActivator extends AbstractUIPlugin {

	/** The plug-in ID */
	public static final String PLUGIN_ID = "uk.ac.diamond.scisoft.icatexplorer.v4.rcp"; //$NON-NLS-1$
