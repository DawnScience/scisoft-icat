...
package uk.ac.diamond.scisoft.icatexplorer.v4.rcp.preferences;
...
public class ICATPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(Composite parent) {
		...
		btnSftpTest.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(NetworkUtils.isReachable(textICATsftpServer.getText())){
					Image okImage = (ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v4.rcp", "icons/ok.png"));;
					btnSftpTest.setImage(okImage);
				}else{
					Image noImage = (ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v4.rcp", "icons/no.png"));;
		...
		btnTestWS.setImage(ResourceManager.getPluginImage("uk.ac.diamond.scisoft.icatexplorer.v4.rcp", "icons/database.png"));
